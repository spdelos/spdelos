...
// Type: CSDB.DataAccess.Implementation.DataDispatchNodeDataAccess
...
{
  public class DataDispatchNodeDataAccess : 
    DbRepository<DataDispatchNode>,
    IDataDispatchNodeDataAccess,
    IRepository<DataDispatchNode>
  {
    public ApplicationDbContext Context { get; set; }

    public DataDispatchNodeDataAccess(ApplicationDbContext context)
