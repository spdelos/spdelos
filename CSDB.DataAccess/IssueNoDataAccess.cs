...
// Type: CSDB.DataAccess.Implementation.IssueNoDataAccess
...
{
  public class IssueNoDataAccess : DbRepository<IssueNo>, IIssueNoDataAccess, IRepository<IssueNo>
  {
    public ApplicationDbContext Context { get; set; }

    public IssueNoDataAccess(ApplicationDbContext context)
