...
// Type: CSDB.DataAccess.Implementation.ResponsiblePartnerCodeDataAccess
...
{
  public class ResponsiblePartnerCodeDataAccess : 
    DbRepository<ResponsiblePartnerCode>,
    IResponsiblePartnerCodeDataAccess,
    IRepository<ResponsiblePartnerCode>
  {
    public ApplicationDbContext Context { get; set; }

    public ResponsiblePartnerCodeDataAccess(ApplicationDbContext context)
