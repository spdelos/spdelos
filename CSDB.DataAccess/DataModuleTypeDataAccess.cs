...
// Type: CSDB.DataAccess.Implementation.DataModuleTypeDataAccess
...
{
  public class DataModuleTypeDataAccess : 
    DbRepository<DataModuleType>,
    IDataModuleTypeDataAccess,
    IRepository<DataModuleType>
  {
    public ApplicationDbContext Context { get; set; }

    public DataModuleTypeDataAccess(ApplicationDbContext context)
