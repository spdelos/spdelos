...
// Type: CSDB.DataAccess.Implementation.ApplicationSettingsDataAccess
...
namespace CSDB.DataAccess.Implementation
{
  public class ApplicationSettingsDataAccess : 
    DbRepository<ApplicationSettings>,
    IApplicationSettingsDataAccess,
    IRepository<ApplicationSettings>
  {
    public ApplicationDbContext Context { get; set; }

    public ApplicationSettingsDataAccess(ApplicationDbContext context)
