...
// Type: CSDB.DataAccess.Implementation.LocationCodeDataAccess
...
{
  public class LocationCodeDataAccess : 
    DbRepository<LocationCode>,
    ILocationCodeDataAccess,
    IRepository<LocationCode>
  {
    public ApplicationDbContext Context { get; set; }

    public LocationCodeDataAccess(ApplicationDbContext context)
