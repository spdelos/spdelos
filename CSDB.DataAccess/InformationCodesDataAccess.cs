...
// Type: CSDB.DataAccess.Implementation.InformationCodesDataAccess
...
{
  public class InformationCodesDataAccess : 
    DbRepository<InformationCodes>,
    IInformationCodesDataAccess,
    IRepository<InformationCodes>
  {
    public ApplicationDbContext Context { get; set; }

    public InformationCodesDataAccess(ApplicationDbContext context)
