    ...
    jQuery.confirmModal = function (message, options, callback) {
        ...
        var html =
            '<div class="modal ' + fadeAnimation + ' modalConfirm" tabindex="-1" aria-modal="true" role="dialog" style="z-index:5000;">' +
                '<div class="modal-dialog ' + modalVerticalCenter + '" style="' + maxWidthStyle + '">' +
                    '<div class="modal-content">' +
                        ...
                        '<div class="modal-footer">' +
                            ...
                            '<button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal" style="min-width:66px;">' + cancelButton + '</button>' +
                        '</div>' +
                    '</div>' +
                '</div>' +
            '</div>';
